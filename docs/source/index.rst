...
Deirokay also integrates easily with `Apache Airflow <https://airflow.apache.org/docs/>`_ with its built-in :ref:``DeirokayOperator<deirokay.airflow.deirokay_operator.DeirokayOperator>``.
