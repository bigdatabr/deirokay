...
def test_isclose_expression(scope, expressions, at_least, at_most, result, backend):
    df = data_reader(
        "tests/statements/test_column_expression.csv",
        options="tests/statements/test_column_expression_options.yaml",
        backend=backend,
